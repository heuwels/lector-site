...
const LECTOR = {
  ...
  anki: "First-party AnkiConnect export",
...
export const comparisons: Record<string, Comparison> = {
  lingq: {
    ...
    rows: [
      ...
      { feature: "Anki export", lector: LECTOR.anki, them: "CSV / Anki-file export (emailed)", advantage: "lector" },
    ...
    ourStrengths: [
      ...
      { title: "Reading + cloze + Anki, joined up", body: "LingQ-style reading, Clozemaster-style frequency cloze, and first-party AnkiConnect export in one app — plus an LLM tutor and a writing journal." },
  ...
  clozemaster: {
    ...
    rows: [
      ...
      { feature: "Anki export", lector: LECTOR.anki, them: "No documented Anki export", advantage: "lector" },
    ...
    ourStrengths: [
      ...
      { title: "Anki export + LLM tutor", body: "Push mined words to Anki over AnkiConnect, and get context-aware translation, a tutor, and writing correction from Claude or a local model." },
    ],
    pickThem:
